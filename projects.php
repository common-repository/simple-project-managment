...
Author: Albdesign
Version: 1.2.2
Text Domain: simple-project-managment
Domain Path: /languages
Author URI: https://profiles.wordpress.org/albdesign
*/

add_action('plugins_loaded', 'albdesign_load_textdomain');
function albdesign_load_textdomain() {
    load_plugin_textdomain( 'simple-project-managment', false, dirname( plugin_basename(__FILE__) ) . '/languages/' );
}

class Albdesign_Project_Management {

	private $plugin_slug ='simple-project-managment';
	...
	function __construct(){
		...
		//add admin css
		add_action('admin_enqueue_scripts', array($this,'simple_project_managment_admin_css'));
	...
	*/
	...
	function admin_footer(){
		...
		if( $typenow=='albdesign_invoice' || $typenow =='albdesign_project' || $typenow == 'albdesign_task' || $typenow == 'albdesign_client' ){
			...
			wp_register_script( 'albdesign-projects-admin-script', $this->get_plugin_url() . 'assets/admin/js/admin.js' );

			// Localize the script with new data
			$translation_array = array(
				'value_from_wp_user' => __( 'Value From Wordpress Account', 'simple-project-managment' ),
				
			);
			wp_localize_script( 'albdesign-projects-admin-script', 'albdesignprojectsadmin', $translation_array );

			// Enqueued script with localized data.
			wp_enqueue_script( 'albdesign-projects-admin-script' );
	...
	*/
	public function simple_project_managment_admin_css(){
		
		global $pagenow, $typenow;
		
		if( $typenow=='albdesign_invoice' || $typenow =='albdesign_project' || $typenow == 'albdesign_task' || $typenow == 'albdesign_client' ){
			wp_enqueue_style('simple-project-managment-circular_admin', $this->get_plugin_url().'assets/admin/css/projects_admin.css');
		}
		 
		wp_register_script('simple-project-managment-circular-diagram',$this->get_plugin_url().'assets/circle-diagram/js/circle-progress.js' ,array( 'jquery' ) );
		wp_register_style('simple-project-managment-circular-diagram',$this->get_plugin_url().'assets/circle-diagram/css/style.css' );
	}
	...
	*/
	function register_cpts() {
		...
		require_once('include/projects.cpt.php');
		...
		*/
		...
		do_action('simple_project_managment_add_new_cpt');
	}	
	...
	function remove_or_add_submenu_pages() { 
		...
		add_submenu_page( 'edit.php?post_type=albdesign_project', __('Reports','simple-project-managment'),  __('Reports','simple-project-managment'), 'manage_options', 'albdesign-project-Reports', array($this,'reports_submenu_page_callback' ));		
		
		//Add "Settings" as submenu to project
		add_submenu_page( 'edit.php?post_type=albdesign_project',  __('Settings','simple-project-managment'),  __('Settings','simple-project-managment'), 'manage_options', 'albdesign-project-settings', array($this,'settings_submenu_page_callback' ));
	...
	*/	
	...
	function add_project_custom_columns($columns) {
		...
		$columns['title'] 					=	apply_filters('albwppm_projects_cpt_list_post_table_header_project_text',__('Project','simple-project-managment'));
		$columns['deadline'] 				=	apply_filters('albwppm_projects_cpt_list_post_table_header_deadline_text',__('Deadline','simple-project-managment'));
		$columns['status'] 	 				=	apply_filters('albwppm_projects_cpt_list_post_table_header_status_text',__('Status','simple-project-managment'));
		$columns['get_tasks_for_project'] 	=	apply_filters('albwppm_projects_cpt_list_post_table_header_tasks_text',__('Tasks','simple-project-managment'));
		$columns['client']	 				=	apply_filters('albwppm_projects_cpt_list_post_table_header_client_text',__('Client','simple-project-managment'));
		$columns['earnings'] 				=	apply_filters('albwppm_projects_cpt_list_post_table_header_earning_text',__('Earning','simple-project-managment'));
	...
	function add_task_custom_columns($columns){
		...
		$columns['title'] 				= 	apply_filters('albwppm_task_cpt_list_post_table_header_task_title_text',__('Task','simple-project-managment'));
		$columns['task_deadline'] 		= 	apply_filters('albwppm_task_cpt_list_post_table_header_task_deadline_text',__('Task Deadline','simple-project-managment'));
		$columns['task_status'] 		= 	apply_filters('albwppm_task_cpt_list_post_table_header_task_status_text',__('Task Status','simple-project-managment'));
		$columns['task_for_project']	= 	apply_filters('albwppm_task_cpt_list_post_table_header_task_project_text',__('Project','simple-project-managment'));
	...
	function add_clients_custom_columns($columns){
		...
		$columns['title'] 								=	apply_filters('albwppm_clients_cpt_list_post_table_header_client_name',__('Client','simple-project-managment'));
		$columns['albdesign_projects_client_projects'] 	=	apply_filters('albwppm_clients_cpt_list_post_table_header_projects',__('Projects','simple-project-managment'));
		$columns['albdesign_projects_client_invoices'] 	=	apply_filters('albwppm_clients_cpt_list_post_table_header_invoices',__('Invoices','simple-project-managment'));
		$columns['albdesign_projects_client_reviews'] 	=	apply_filters('albwppm_clients_cpt_list_post_table_header_reviews',__('Reviews','simple-project-managment'));		
	...
	function add_invoice_custom_columns($columns){
		...
		$columns['title'] 										=	apply_filters('albwppm_invoice_cpt_list_post_table_header_invoice_name',__('Invoice','simple-project-managment'));
		$columns['albdesign_projects_invoice_total'] 			=	apply_filters('albwppm_invoice_cpt_list_post_table_header_invoice_total',__('Total','simple-project-managment'));
		$columns['albdesign_projects_invoice_status'] 			=	apply_filters('albwppm_invoice_cpt_list_post_table_header_invoice_status',__('Status','simple-project-managment'));
		$columns['albdesign_projects_invoice_for_client'] 		=	apply_filters('albwppm_invoice_cpt_list_post_table_header_invoice_client_name',__('Client','simple-project-managment'));

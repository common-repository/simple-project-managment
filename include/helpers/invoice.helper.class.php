...
class Albdesign_Projects_Invoice_Helpers{
	...
	*/
	public static function get_invoices_for_client_extra_columns($clientid,$return_or_show='return'){
		...
		if($clientid && ( $clientid > 0)){
			...
			$invoicesAssociateWithClient = __('No Invoices','simple-project-managment');
	...
	*/
	static function get_invoice_meta_value_by_invoice_id($id,$meta=''){
		...
		return ($meta_value) ? $meta_value : __('Not Set','simple-project-managment');
	...
	*/
	static function get_invoice_notes_value_by_invoice_id($id,$meta=''){
		...
		$value_to_return = __('Not Set','simple-project-managment');
	...
	*/
	...
	static function dropdown_paid_status(){
		...
		?><select  name="albdesign_invoice_status_for_report_page">
			<option value=""><?php echo __('All','simple-project-managment');?></option>
			<option value="unpaid" <?php echo ($selected == 'unpaid') ? ' selected = "selected" ' : ''; ?>><?php echo __('Unpaid','simple-project-managment') ?></option>
			<option value="paid" <?php echo ($selected == 'paid') ? ' selected = "selected" ' : ''; ?>><?php echo __('Paid','simple-project-managment') ?></option>
			<option value="overdue" <?php echo ($selected == 'overdue') ? ' selected = "selected" ' : ''; ?>><?php echo __('Overdue','simple-project-managment') ?></option>
			<option value="cancelled" <?php echo ($selected == 'cancelled') ? ' selected = "selected" ' : ''; ?>><?php echo __('Cancelled','simple-project-managment') ?></option>
		</select>
	...
	*/
	...
	static function get_results_for_report(){
		...
		echo  apply_filters('albwppm_reports_invoices_page_found_invoices_title' , sprintf( _n( '<h3>Found  %s invoice </h3>', '<h3>Found  %s invoices </h3>', $invoices_found, 'simple-project-managment' ), $invoices_found ));
				...
				<thead>
					<tr>
						...
						<th scope="col"  class="check-column manage-column column-title sortable desc " style="padding-top:0px;width: 3em;">
							<a ><span><strong><?php echo __('Title','simple-project-managment') ?></strong></span></a>
						</th>		
						<th scope="col"  class="check-column manage-column column-title sortable desc " style="padding-top:0px;width: 3em;">
							<a ><span><strong><?php echo __('Status','simple-project-managment') ?></strong></span></a>
						</th>	
						<th scope="col"  class="check-column manage-column column-title sortable desc " style="padding-top:0px;width: 3em;">
							<a ><span><strong><?php echo __('Amount','simple-project-managment') ?></strong></span></a>
						</th>							
						<th scope="col"  class="check-column manage-column column-title sortable desc " style="padding-top:0px;width: 3em;">
							<a ><span><strong><?php echo __('To be paid by','simple-project-managment') ?></strong></span></a>
						</th>	
						<th scope="col"  class="check-column manage-column column-title sortable desc " style="padding-top:0px;width: 3em;">
							<a ><span><strong><?php echo __('Paid on','simple-project-managment') ?></strong></span></a>
						</th>							
						<th scope="col"  class="check-column manage-column column-title sortable desc " style="padding-top:0px;width: 3em;">
							<a ><span><strong><?php echo __('Client','simple-project-managment') ?></strong></span></a>
						</th>		

...
class Albdesign_Projects_Project_Helpers{
	...
	public static function albdesign_get_human_project_status_by_meta_value_as_text($status){
		...
		switch($status){
			...
			case 'project_status_lead':
				$projectStatusToDisplay = __('Lead','simple-project-managment');
				break;
				
			case 'project_status_on_hold':
				$projectStatusToDisplay = __('On Hold','simple-project-managment');
				break;

			case 'project_status_waiting_feedback':
				$projectStatusToDisplay = __('Awaiting Feedback','simple-project-managment');
				break;			
			
			case 'project_status_ongoing':
				$projectStatusToDisplay = __('Ongoing','simple-project-managment');
				break;
				
			case 'project_status_finished':
				$projectStatusToDisplay = __('Completed','simple-project-managment');
				break;					
	...
	*/
	public static function get_projects_for_client_extra_columns($clientid,$return_or_show='return'){
		...
		if($clientid && ( $clientid > 0)){
			...
			$projectsAssociateWithClient= apply_filters('albwppm_no_projects_from_this_client_yet',__('No Projects','simple-project-managment'));
	...
	static function convert_priority_to_human_priority($priority){
		...
		switch ($priority){
			...
			case 'project_priority_not_set':
				$return = __('Not Set','simple-project-managment');;
				break;
				
			case 'project_priority_low':
				$return = __('Low','simple-project-managment');
				break;
				
			case 'project_priority_normal':
				$return = __('Normal','simple-project-managment');
				break;
				
			case 'project_priority_high':
				$return = __('High','simple-project-managment');
				break;	
	...
	*/
	...
	static function dropdown_statuses(){
		...
		?><select name="albdesign_project_status_field">
			<option  value="" <?php echo ($selected == '') ? ' selected = "selected" ' : ''; ?> ><?php echo  __('All','simple-project-managment'); ?></option>
			<option value="project_status_not_set" <?php echo ($selected == 'project_status_not_set') ? ' selected = "selected" ' : ''; ?> ><?php  echo  __('Not set','simple-project-managment'); ?></option>
			<option value="project_status_lead" <?php echo ($selected == 'project_status_lead') ? ' selected = "selected" ' : ''; ?> ><?php echo   __('Lead','simple-project-managment'); ?></option>
			<option value="project_status_ongoing"  <?php echo ($selected == 'project_status_ongoing') ? ' selected = "selected" ' : ''; ?> ><?php echo  __('Ongoing','simple-project-managment'); ?></option>
			<option value="project_status_on_hold" <?php echo ($selected == 'project_status_on_hold') ? ' selected = "selected" ' : ''; ?> ><?php  echo  __('Lead','simple-project-managment'); ?></option>
			<option value="project_status_waiting_feedback" <?php echo ($selected == 'project_status_waiting_feedback') ? ' selected = "selected" ' : ''; ?> ><?php  echo  __('Awaiting Feedback','simple-project-managment'); ?></option>
			<option value="project_status_finished" <?php echo ($selected == 'project_status_finished') ? ' selected = "selected" ' : ''; ?> ><?php  echo   __('Completed','simple-project-managment'); ?></option>
		</select>
	...
	*/
	...
	static function dropdown_priorities(){
		...
		?><select name="albdesign_project_priority_field">
			...
			<option value="project_priority_not_set"  <?php echo ($selected == 'project_priority_not_set') ? ' selected = "selected" ' : ''; ?> ><?php echo  __('Not Set','simple-project-managment'); ?></option>
			<option value="project_priority_low"  <?php echo ($selected == 'project_priority_low') ? ' selected = "selected" ' : ''; ?> ><?php echo __('Low','simple-project-managment'); ?></option>
			<option value="project_priority_normal" <?php echo ($selected == 'project_priority_normal') ? ' selected = "selected" ' : ''; ?> ><?php echo __('Normal','simple-project-managment'); ?></option>
			<option value="project_priority_high" <?php echo ($selected == 'project_priority_high') ? ' selected = "selected" ' : ''; ?> ><?php echo __('High','simple-project-managment'); ?></option>
		</select>
	...
	*/
	...
	static function dropdown_before_exactly_after($select_name){
		...
		<select name="albdesign_project_<?php echo $select_name;?>_before_exactly_after" id="albdesign_<?php echo $select_name;?>_before_exactly_after">
			<option value="0" <?php echo ($selected == '0') ? ' selected = "selected" ' : ''; ?>> <?php echo __('All','simple-project-managment'); ?> </option>
			<option value="before" <?php echo ($selected == 'before') ? ' selected = "selected" ' : ''; ?>> <?php echo __('Before','simple-project-managment'); ?> </option>
			<option value="exactly" <?php echo ($selected == 'exactly') ? ' selected = "selected" ' : ''; ?>> <?php echo __('Exactly','simple-project-managment'); ?> </option>
			<option value="after" <?php echo ($selected == 'after') ? ' selected = "selected" ' : ''; ?>> <?php echo __('After','simple-project-managment'); ?> </option>
		</select>
		</div>
	...
	*/
	static function get_results_for_report(){
		...
		$projects_found = sizeof($results_all_projects) ; 


		echo  apply_filters('albwppm_reports_project_page_found_projects_title' , sprintf( _n( '<h3>Found  %s project </h3>', '<h3>Found  %s projects </h3>', $projects_found, 'simple-project-managment' ), $projects_found ));
				...
				<thead>
					<tr>
						...
						<th scope="col" class="manage-column column-title sortable desc" >
							<a class="table_header_text_link"><span><strong><?php echo __('Title','simple-project-managment'); ?></strong></span></a>
						</th>
						<th scope="col"  class="manage-column column-title sortable desc" >
							<a class="table_header_text_link"><span><strong><?php echo __('Client','simple-project-managment'); ?></strong></span></a>
						</th>			

						<th scope="col" class="manage-column column-title sortable desc" >
							<a class="table_header_text_link"><span><strong><?php echo  __('Progress','simple-project-managment'); ?> %</strong></span></a>
						</th>							
						
						<th scope="col" class="manage-column column-title sortable desc" >
							<a class="table_header_text_link"><span><strong><?php echo __('Status','simple-project-managment'); ?></strong></span></a>
						</th>
						<th scope="col" class="manage-column column-title sortable desc" >
							<a class="table_header_text_link"><span><strong><?php  echo __('Priority','simple-project-managment'); ?></strong></span></a>
						</th>	

						<th scope="col" class="manage-column column-title sortable desc" >
							<a class="table_header_text_link"><span><strong><?php echo  __('Start Date','simple-project-managment'); ?></strong></span></a>
						</th>
						<th scope="col" class="manage-column column-title sortable desc" >
							<a class="table_header_text_link"><span><strong><?php echo  __('Target end date','simple-project-managment'); ?></strong></span></a>
						</th>
						<th scope="col" class="manage-column column-title sortable desc" >
							<a class="table_header_text_link"><span><strong><?php echo __('Actual end date','simple-project-managment'); ?></strong></span></a>
						</th>						

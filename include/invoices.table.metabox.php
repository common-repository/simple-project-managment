...
class Albdesign_Invoice_Table_Metabox {
	...
	*/
	...
	function localize_scripts(){
		...
		$translation_array = array(
			'table_invoice_add_record_title' => apply_filters('albwppm_table_invoice_add_record_title',__('Add new item','simple-project-managment')),
			'table_invoice_line_total'		 => apply_filters('albwppm_table_invoice_line_total_title',__('Line total','simple-project-managment')),
			'table_invoice_line_quantity'	 => apply_filters('albwppm_table_invoice_line_quantity_title',__('Quantity','simple-project-managment')),
			'table_invoice_line_price'	 	 => apply_filters('albwppm_table_invoice_line_price_title',__('Unit Price','simple-project-managment')),
			'table_invoice_line_item'	 	 => apply_filters('albwppm_table_invoice_line_item_title',__('Item','simple-project-managment')),
			'table_invoice_items_on_invoice_title'	 	 => apply_filters('albwppm_table_invoice_items_on_invoice_title',__('Items on invoice','simple-project-managment')),
			'table_invoice_save_new_item_button_title'	 	 => apply_filters('albwppm_table_invoice_save_new_item_button_title',__('Save','simple-project-managment')),
			'table_invoice_cancel_new_item_button_title'	 	 => apply_filters('albwppm_table_invoice_cancel_new_item_button_title',__('Cancel','simple-project-managment')),
			'table_invoice_edit_item_popup_title'	 	 => apply_filters('albwppm_table_invoice_edit_item_popup_title',__('Edit item','simple-project-managment')),
			'table_invoice_delete_item_popup_title_are_you_sure'	 	 => apply_filters('albwppm_table_invoice_delete_item_popup_title_are_you_sure',__('Are you sure','simple-project-managment')),
			'table_invoice_delete_item_confirmation_text'	 	 => apply_filters('albwppm_table_invoice_delete_item_confirmation_text',__('This item will be deleted','simple-project-managment')),
			'table_invoice_delete_item_button_text'	 	 => apply_filters('albwppm_table_invoice_delete_item_button_text',__('Delete','simple-project-managment')),
			'table_invoice_no_data_available'	 	 => apply_filters('albwppm_table_invoice_no_data_available',__('No data available','simple-project-managment')),
			'table_invoice_loading_records'	 	 => apply_filters('albwppm_table_invoice_loading_records',__('Loading records','simple-project-managment')),
			'table_invoice_no_items_on_invoice'	 	 => apply_filters('albwppm_table_invoice_no_items_on_invoice',__('No items on invoice','simple-project-managment')),
		);
	...
	*/
	...
	public function add_meta_box( $post_type ) {
            ...
            if ( in_array( $post_type, $post_types )) {
				add_meta_box(
					'some_meta_box_name'
					,__( 'Prepare invoice', 'simple-project-managment' )
								...
								<tbody>
									...
									<tr>
										<td class="at-field" style="vertical-align: top;" >
											<div><?php echo apply_filters('albwppm_invoice_cpt_single_private_notes_label',__('Invoice Private Notes','simple-project-managment')); ?></div>
										...
										<td class="at-field" style="vertical-align: top;" colspan="2" >
											<div> <?php echo apply_filters('albwppm_invoice_cpt_single_public_notes_label',__('Invoice public notes (visible on invoice)','simple-project-managment'));?> </div>
											...
											<div>
												...
												<input type="checkbox" name="albdesign_show_general_invoice_terms_also" id="albdesign_show_general_invoice_terms_also" <?php echo $invoice_show_default_terms;?> ><?php echo apply_filters('albwppm_invoice_cpt_single_show_general_terms_also_label',__('Show general terms also','simple-project-managment'));?>
											</div>
										</td>										
									...
									<tr>
										<td class="at-field" style="vertical-align: top;" >
											<div> <?php echo apply_filters('albwppm_invoice_cpt_single_invoice_status_label',__('Invoice status','simple-project-managment'));?> </div>
											<select class="at-posts-select" name="albdesign_projects_invoices_status_field_id" id="albdesign_projects_invoices_status_field_id">
												<option value="unpaid" 		<?php selected($invoice_status,'unpaid');?> ><?php echo apply_filters('albwppm_invoice_cpt_single_invoice_status_unpaid_dropdown_option_text',__('Unpaid','simple-project-managment'));?></option>
												<option value="paid"  		<?php selected($invoice_status,'paid');?> ><?php echo apply_filters('albwppm_invoice_cpt_single_invoice_status_paid_dropdown_option_text',__('Paid','simple-project-managment'));?></option>
												<option value="overdue" 	<?php selected($invoice_status,'overdue');?> ><?php echo apply_filters('albwppm_invoice_cpt_single_invoice_status_overdue_dropdown_option_text',__('Overdue','simple-project-managment'));?></option>
												<option value="cancelled"  	<?php selected($invoice_status,'cancelled');?> ><?php echo apply_filters('albwppm_invoice_cpt_single_invoice_status_cancelled_dropdown_option_text',__('Cancelled','simple-project-managment'));?></option>
											</select>
										</td>
										
										<td class="at-field"  style="vertical-align: top;" >
											<div><?php echo apply_filters('albwppm_invoice_cpt_single_invoice_to_be_paid_by_date_label',__('To be paid by date','simple-project-managment'));?></div>
										...
										<td class="at-field"  style="vertical-align: top;" >
											<div> <?php echo apply_filters('albwppm_invoice_cpt_single_invoice_paid_date_label',__('Paid Date','simple-project-managment'));?> </div>
									...
									<tr>
										<td class="at-field" valign="top">
											<div class="at-label">
												<label for="albdesign_projects_invoices_client_field_id"><?php echo apply_filters('albwppm_invoice_cpt_single_invoice_client_label',__('Client','simple-project-managment'));?> </label>
											</div>
											...
											<select class="at-posts-select" name="albdesign_projects_invoices_client_field_id" id="albdesign_projects_invoices_client_field_id">
												<option value="-1"><?php echo apply_filters('albwppm_invoice_cpt_single_invoice_client_no_client_selected_option_text',__('No client selected','simple-project-managment'));?></option>
												<?php
													//get all clients
										...
										<td class="at-field" valign="top">
											<div class="at-label">
												<label for="albdesign_projects_invoices_project_list"><?php echo apply_filters('albwppm_invoice_cpt_single_invoice_related_to_project_label',__('Related to project','simple-project-managment'));?></label>
											</div>
									...
									<tr>
										...
										<td class="at-field" valign="top" >
											...
											<div>
												<div class="albdesign_discount_title"><span > <?php echo apply_filters('albwppm_invoice_cpt_single_invoice_discount_label',__('Discount','simple-project-managment'));?> </span> </div>
												...
												<div class="albdesign_discount_form">
													...
													<select name="invoice_discount_type" id="invoice_discount_type"  class="albdesign_invoice_discount_fields" >
														<option value="none" 	<?php selected( Albdesign_Invoice_Table_Metabox::get_vat_or_discount('discountType') ,'0' );?> ><?php echo apply_filters('albwppm_invoice_cpt_single_invoice_discount_none_option_text',__('None','simple-project-managment'));?></option>
														<option value="percent" <?php selected( Albdesign_Invoice_Table_Metabox::get_vat_or_discount('discountType') , 'percent');?> ><?php echo apply_filters('albwppm_invoice_cpt_single_invoice_discount_percent_option_text',__('Percent','simple-project-managment'));?></option>
														<option value="amount" 	<?php selected( Albdesign_Invoice_Table_Metabox::get_vat_or_discount('discountType') , 'amount' );?> ><?php echo apply_filters('albwppm_invoice_cpt_single_invoice_discount_amount_option_text',__('Amount','simple-project-managment'));?></option>
													</select>
											...
											<div>
												<div class="albdesign_vat_title">
													<span ><?php echo apply_filters('albwppm_invoice_cpt_single_invoice_vat_label',__('VAT','simple-project-managment'));?> </span>    
												</div>
											...
											<div style="display:none">
												<p><?php echo apply_filters('albwppm_invoice_cpt_single_invoice_total_label',__('VAT','simple-project-managment'));?> <span id="totalInvoiceCost">0</span> </p>
											</div>
										...
										<td class="at-field" colspan="3" valign="top" style="vertical-align: top;">
												<div>
													<div class="albdesign_vat_title">
														<span > <?php echo apply_filters('albwppm_invoice_cpt_single_invoice_currency_label',__('Currency','simple-project-managment'));?> </span>    
													</div>
													<div class="albdesign_vat_form">
												...
												<div>
													<div class="albdesign_vat_title">
														<span > <?php echo apply_filters('albwppm_invoice_cpt_single_invoice_currency_position_label',__('Currency Position','simple-project-managment'));?> </span>    
													</div>
													<div class="albdesign_vat_form">
														<select  name="invoice_currency_position" id="invoice_currency_position">
															<option <?php selected( $invoice_currency_position, 'left'); ?>   value="left"><?php  echo apply_filters('albwppm_invoice_cpt_single_invoice_currency_position_left_of_price_option_text',__('Left of price','simple-project-managment'));?> </option >
															<option  <?php selected(  $invoice_currency_position, 'right'); ?>    value="right"><?php echo apply_filters('albwppm_invoice_cpt_single_invoice_currency_position_right_of_price_option_text',__('Right of price','simple-project-managment'));?> </option>
													</select>
													</div>
													<div class="albdesign_clear"></div>
												</div>
									...
									<tr>
										<td class="at-field" valign="top" colspan="3">
												<input type="button" value="<?php echo apply_filters('albwppm_invoice_cpt_single_invoice_apply_vat_discount_button_text',__('1. Apply VAT and discount','simple-project-managment'));?>" class="button button-primary button-large albdesign_invoice_page_buttons" id="albdesign_apply_vat_btn">
												
												<input type="button" id="albdesign_preview_invoice" value="<?php echo apply_filters('albwppm_invoice_cpt_single_invoice_generate_invoice_button_text',__('Generate Invoice','simple-project-managment')) ?>" class="button button-primary button-large albdesign_invoice_page_buttons">
												
												
												<form method="post">
													<input type="submit" id="albdesign_projects_download_invoice" name="albdesign_projects_download_invoice" value="<?php echo apply_filters('albwppm_invoice_cpt_single_invoice_download_invoice_button_text',__('3.Download Invoice','simple-project-managment'));?>" class="button button-primary button-large albdesign_invoice_page_buttons">
												</form>
												
												<span class="albdesign_apply_vat_loader albdesign_loading_ajax"><?php echo __('Loading','simple-project-managment') ?></span>
									...
									<tr>
										<td class="at-field" valign="top" colspan="3">
												...
												<span class="invoice_preview_text"><?php echo apply_filters('albwppm_invoice_cpt_single_invoice_pdf_invoice_preview_label',__('PDF Invoice Preview','simple-project-managment'));?></span>
	...
	*/
	public function get_client_info($invoiceID,$what){
		...
		$no_client_found = apply_filters('albwppm_invoice_cpt_single_invoice_no_client_found_label',__('No Client Found','simple-project-managment'));
	...
	*/
	public  function albdesign_project_invoice_preview_pdf_ajax(){
		...
		//Get Dompdf 
		require_once ( $this->mainPluginPath .'/assets/admin/dompdf/autoload.inc.php');

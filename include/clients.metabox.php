...
*/
	...
	$clients_info_config = array(
		...
		'title'          => apply_filters('albwppm_clients_cpt_personal_information_metabox_title',__('Personal Information','simple-project-managment')),          // meta box title
	...
	//Associate client to existing WP account
		...
		$getUserFromWpArray['dont_associate'] = apply_filters('albwppm_client_cpt_associate_with_user_dropdown_dont_associate_option_text',__('Dont Associate','simple-project-managment'));
		...
		$clients_info_metabox->addSelect(
										...
										$getUserFromWpArray,
										array(
											'name'=>  apply_filters('albwppm_client_cpt_associate_with_existing_wp_account_dropdown_label',__('Associate with existing WordPress account','simple-project-managment')), 
											'std'=> array(
														'dont_associate'
													),
										)
	...
	$clients_info_array=array(
		...
		array(
			...
			'type' 		=> 'text',
			'options' 	=> array(
				'name' 	=> apply_filters('albwppm_single_client_cpt_first_name_label_text',__('First name','simple-project-managment')),
				'group' => 'start',
		...
		array(
			...
			'type' 		=> 'text',
			'options' 	=> array(
				'name' 	=> 	apply_filters('albwppm_single_client_cpt_middle_name_label_text',__('Middle name','simple-project-managment')),
				'class'	=> 'albwppm_text_input',
			)
		),		
		array(
			...
			'type' 		=> 'text',
			'options' 	=> array(
				'name' 	=> 	apply_filters('albwppm_single_client_cpt_last_name_label_text',__('Last name','simple-project-managment')),
				'group' => 	'end',			
				'class'	=> 'albwppm_text_input',				
			)
		),
		...
		array(
			...
			'type' 		=> 'text',
			'options' 	=> array(
				'name' 	=> 	apply_filters('albwppm_single_client_cpt_email_label_text',__('Email','simple-project-managment')),
				'group' => 	'start',
				'class'	=> 'albwppm_text_input',
			)
		),
		array(
			...
			'type' 		=> 'text',
			'options' 	=> array(
				'name' 	=> 	apply_filters('albwppm_single_client_cpt_phone_label_text',__('Phone','simple-project-managment')),
				'class'	=> 'albwppm_text_input',
		...
		array(
			...
			'type' 		=> 'text',
			'options' 	=> array(
				'name' 	=> 	apply_filters('albwppm_single_client_cpt_mobile_label_text',__('Mobile','simple-project-managment')),
				'group' => 	'end',	
				'class'	=> 'albwppm_text_input',
			)
		),		
		...
		array(
			...
			'type' 		=> 'textarea',
			'options' 	=> array(
				'name' 	=> 	apply_filters('albwppm_single_client_cpt_address_label_text',__('Address','simple-project-managment')),
		...
		array(
			...
			'type' 		=> 'text',
			'options' 	=> array(
				'name' 	=> 	apply_filters('albwppm_single_client_cpt_skype_label_text',__('Skype','simple-project-managment')),
				'group' => 	'start',
				'class'	=> 'albwppm_text_input',				
			)
		),
		array(
			...
			'type' 		=> 'text',
			'options' 	=> array(
				'name' 	=> 	apply_filters('albwppm_single_client_cpt_facebook_label_text',__('Facebook','simple-project-managment')),
				'class'	=> 'albwppm_text_input',				
...
*/
	...
	$clients_project_config = array(
		...
		'title'          => apply_filters('albwppm_clients_cpt_projects_metabox_title',__('Client Projects','simple-project-managment')),          // meta box title
		'pages'          => array('albdesign_client'),      // post types, accept custom post types as well, default is array('post'); optional
...
*/
	$clients_invoices_config = array(
		...
		'title'          => apply_filters('albwppm_clients_cpt_invoices_metabox_title',__('Client Invoices','simple-project-managment')),          // meta box title
		'pages'          => array('albdesign_client'),      // post types, accept custom post types as well, default is array('post'); optional
		'context'        => 'side',            // where the meta box appear: normal (default), advanced, side; optional
...
*/
	...
	$clients_review_config = array(
		...
		'title'          => apply_filters('albwppm_clients_cpt_reviews_metabox_title',__('Client Review','simple-project-managment')),         
	...
	$clients_reviews_metabox->addSelect($prefix_clients.'review_field',array(
					'client_no_review_set'	=>	apply_filters('albwppm_client_reviews_dropdown_review_default_text',__('No reviews','simple-project-managment')) , 

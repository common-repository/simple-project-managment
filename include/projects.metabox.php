...
$config = array(
	...
	'title'          => apply_filters('alwppm_project_cpt_project_infos_metabox_title',__('Project Infos','simple-project-managment')),          
...
$projects_meta->addText($prefix.'estimate_field_id',array(
														'name'	=>	apply_filters('albwppm_project_estimate_label_text',__('Estimate','simple-project-managment'))
													)
												);

$projects_meta->addTextarea($prefix.'private_notes_field_id',array(
														'name'	=> 	apply_filters('albwppm_project_private_notes_label_text',__('Private Project Notes','simple-project-managment')), 
														'std'	=>	'',
														'group'	=>	'start'
													)
												);
...
$projects_meta->addTextarea($prefix.'public_notes_field_id',array(
														'name'	=>	apply_filters('albwppm_project_public_notes_label_text',__('Public Project Notes','simple-project-managment')), 
														'std'	=>	'',
														'group'	=>	'end'
													)
												);
...
//Project associated to client
	$projects_meta->addPosts($prefix.'client_field_id',array(
														...
														array(
															'name'			=> apply_filters('albwppm_project_associate_to_client_label_text',__('Associate to client','simple-project-managment')),
															'emptylabel'	=> apply_filters('albwppm_project_associate_to_client_no_client_selected_label_text',__('No client selected','simple-project-managment'))
														)
											);
...
//Project Start Date , end date 
	$projects_meta->addDate($prefix.'start_date_field_id',array(
											'name'=> apply_filters('albwppm_project_start_date_label_text',__('Start Date','simple-project-managment').' ( i.e 24-12-2015 )'),
											'format' => 'd-m-yy',
											'group' => 'start')
										);
										
	$projects_meta->addDate($prefix.'target_end_date_field_id',array(
											'name'=> apply_filters('albwppm_project_target_end_date_label_text',__('Target End Date','simple-project-managment').' ( i.e 24-12-2015 )'),
											'format' => 'd-m-yy')
										);
	
	$projects_meta->addDate($prefix.'end_date_field_id',array(
											'name'=> apply_filters('albwppm_project_actual_end_date_label_text',__('Actual End Date','simple-project-managment').' ( i.e 24-12-2015 )'),
											'format' => 'd-m-yy',
											'group' => 'end')
										);
...
//Project Status .... Lead , Ongoing , Finished
	...
	$projects_meta->addSelect($prefix.'status_field',
								array(
									'project_status_not_set'			=>	apply_filters('albwppm_project_status_dropdown_not_set_text',__('Not Set','simple-project-managment')) , 
									'project_status_lead'				=>	apply_filters('albwppm_project_status_dropdown_lead_text',__('Lead','simple-project-managment')) , 
									'project_status_ongoing'			=>	apply_filters('albwppm_project_status_dropdown_ongoing_text',__('Ongoing','simple-project-managment')) , 
									'project_status_on_hold' 			=> 	apply_filters('albwppm_project_status_dropdown_on_hold_text',__('Onhold','simple-project-managment')) , 
									'project_status_waiting_feedback' 	=> 	apply_filters('albwppm_project_status_dropdown_awaiting_feedback_text',__('Awaiting Feedback','simple-project-managment')) , 
									'project_status_finished'			=>	apply_filters('albwppm_project_status_dropdown_completed_text',__('Completed','simple-project-managment')) ,
								),
								array(
									'name'	=>	apply_filters('albwppm_project_status_dropdown_label_text',__('Project Status ','simple-project-managment')), 
...
//Project progress	
	$projects_meta->addSelect($prefix.'progress_field',array(
													'not_set'	=>	apply_filters('albwppm_project_progress_dropdown_not_set_text',__('Not Set','simple-project-managment')) ,
												...
												array(
													'name'	=>	apply_filters('albwppm_project_progress_dropdown_label_text',__('Project Progress ','simple-project-managment')), 
													'std'	=>	array('not_set')
												)
											);	
...
//Project priority
	$projects_meta->addSelect($prefix.'priority_field',array(
														'project_priority_not_set'	=>	apply_filters('albwppm_project_priority_dropdown_not_set_text',__('Not Set','simple-project-managment')),
														'project_priority_low'		=>	apply_filters('albwppm_project_priority_dropdown_low_text',__('Low','simple-project-managment')),
														'project_priority_normal'	=>	apply_filters('albwppm_project_priority_dropdown_normal_text',__('Normal','simple-project-managment')),
														'project_priority_high' 	=>	apply_filters('albwppm_project_priority_dropdown_high_text',__('High','simple-project-managment')),
													),
													array(
														'name'	=>	apply_filters('albwppm_project_priority_dropdown_label_text',__('Project Priority','simple-project-managment')), 
...
*/
	...
	$projects_tasks_config = array(
		...
		'title'          => apply_filters('albwppm_projects_cpt_project_tasks_metabox_title',__('Project Tasks','simple-project-managment')),          // meta box title
	...
	$tasksAssociateWithProject = apply_filters('albwppm_projects_cpt_project_tasks_metabox_no_tasks_yet',__('Project Tasks','simple-project-managment'));
	...
	if(isset($_GET['post'])){
		...
		$taskStatusToDisplay = __('Not Set','simple-project-managment'); 

...
class Albdesign_Projects_Clients_Helpers{
	...
	*/
	public static function get_invoices_for_client_extra_columns($clientid,$return_or_show='return'){
		...
		if($clientid && ( $clientid > 0)){
			...
			$invoiceStatusToDisplay = __('Not Set','simple-project-managment');
			...
			if(sizeof($results_invoices_for_client)>=1){
				...
				foreach($results_invoices_for_client as $single_invoice_for_client){
					...
					if(get_post_meta($single_invoice_for_client->ID , '_albdesign_invoice_notes', true)){
						...
						$invoiceStatusToDisplay = (isset($invoiceStatus['status'])) ? ucfirst($invoiceStatus['status']) :  __('Not Set','simple-project-managment');
					}
	...
	*/
	static function get_all_as_dropdown(){
		...
		$dropdown_options ='<option value="-1">'. __('All','simple-project-managment').'</option>';
	...
	*/
	static function get_results_for_report(){
		...
		echo  apply_filters('albwppm_reports_clients_page_found_clients_title' , sprintf( _n( '<h3>Found  %s client </h3>', '<h3>Found  %s clients </h3>', $clients_found, 'simple-project-managment' ), $clients_found ));
			...
			<table class="wp-list-table widefat fixed posts">
				<thead>
					<tr>
						...
						<th scope="col"  class="manage-column column-title sortable desc" >
							<a ><span><strong><?php echo __('Name','simple-project-managment') ?></strong></span></a>
						</th>			

						<th scope="col" class="manage-column column-title sortable desc" >
							<a ><span><strong><?php echo __('Surname','simple-project-managment') ?></strong></span></a>
						</th>							
						
						<th scope="col" class="manage-column column-title sortable desc" >
							<a ><span><strong><?php echo __('Email','simple-project-managment') ?></strong></span></a>
						</th>
						<th scope="col" class="manage-column column-title sortable desc" >
							<a ><span><strong><?php echo __('Phone','simple-project-managment') ?></strong></span></a>
						</th>	

						<th scope="col" class="manage-column column-title sortable desc" >
							<a ><span><strong><?php echo __('Mobile','simple-project-managment') ?></strong></span></a>
						</th>
						<th scope="col" class="manage-column column-title sortable desc" >
							<a ><span><strong><?php echo __('Skype','simple-project-managment') ?></strong></span></a>
						</th>
